// Simple fix for the DashboardStats component
// This patch directly fixes the component that's causing the build error
...
// Fixed styled component that uses theme.shadows.medium instead of theme.boxShadow
