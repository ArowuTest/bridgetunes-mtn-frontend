...
const DrawHistory: React.FC<DrawHistoryProps> = ({ selectedDraw }) => { // Added props destructuring
    ...
    <Card>
      ...
      {selectedDraw && (
        <div style={{ marginBottom: '1.5rem' }}>
          <p><strong>Selected Draw:</strong> {selectedDraw.name}</p>
          <p><strong>Type:</strong> {selectedDraw.type}</p>
          <p><strong>Scheduled Date:</strong> {formatDate(selectedDraw.date)}</p>
        </div>
      )}
