...
const WinnersPage: React.FC = () => {
  ...
  const allTimeWinners = [
    ...
    },
    {
      ...
      drawType: "2nd Prize",
      quote:
        "This prize will help me complete my house project. Thank you MTN!",
    },
    {
      id: 9,
      name: "Ibrahim M.",
        ...
        >
          ...
          <Section>
            <Paragraph>
              ...
              amazing cash prizes. Check out our recent winners and their
              stories below.
            </Paragraph>
          ...
          <Section>
            ...
            <Paragraph>
              Below is a comprehensive list of all winners from our recent
              draws. Winners are announced daily after each draw is completed.
            </Paragraph>
          ...
          <InfoBox>
            <strong>Join our winners!</strong> Opt-in now and top up your MTN
            line to participate in our daily and weekly draws. You could be our
            next big winner!
          </InfoBox>
        </motion.div>
      </MainContent>
