      ...
      {!success ? (
              ...
              <Col span={6}>
                ...
                <FormGroup>
                  ...
                  >
                    ...
                    <option value="active">
                      Active Users (Topup in last 30 days)
                    </option>
                    <option value="inactive">
                      Inactive Users (No topup in 30+ days)
                    </option>
        ...
        <SuccessAnimation>
          ...
          <p style={{ textAlign: "center", marginBottom: "1.5rem" }}>
            Your notification campaign has been created and will be processed
            shortly. Recipients will receive their messages according to the
            selected segment.
          </p>
