  ...
  const upcomingStreams = [
    {
      ...
      date: 'April 29, 2025',
      time: '7:00 PM WAT',
      description: 'Join us for the Monday daily draw where we\'ll select winners for numbers ending in 0 & 1. Jackpot prize: ₦1,000,000!'
    },
    {
      id: 2,
      ...
      date: 'April 30, 2025',
      time: '7:00 PM WAT',
      description: 'Join us for the Tuesday daily draw where we\'ll select winners for numbers ending in 2 & 3. Jackpot prize: ₦1,000,000!'
    },
    {
      id: 3,
      ...
      date: 'May 1, 2025',
      time: '7:00 PM WAT',
      description: 'Join us for the Wednesday daily draw where we\'ll select winners for numbers ending in 4 & 5. Jackpot prize: ₦1,000,000!'
    }
  ];
  ...
  const pastStreams = [
    {
      ...
      date: 'April 26, 2025',
      time: '8:00 PM WAT',
      description: 'Watch our Saturday special draw with a jackpot prize of ₦3,000,000! All MTN numbers were eligible for this draw.'
    },
    {
      id: 5,
      ...
      date: 'April 25, 2025',
      time: '7:00 PM WAT',
      description: 'Watch our Friday daily draw where we selected winners for numbers ending in 8 & 9. Jackpot prize: ₦1,000,000!'
    },
    {
      id: 6,
      ...
      date: 'April 24, 2025',
      time: '7:00 PM WAT',
      description: 'Watch our Thursday daily draw where we selected winners for numbers ending in 6 & 7. Jackpot prize: ₦1,000,000!'
    }
  ];
  ...
  return (
    <PageContainer>
      <Head>
        ...
        <meta name="description" content="Watch live draws for the MTN MyNumba Don Win promotion and see winners selected in real-time." />
      </Head>
      ...
      <MainContent>
        ...
        >
          ...
          <Section>
            <Paragraph>
              Watch our daily and weekly draws live to see winners selected in real-time! 
              All draws are conducted transparently under the supervision of regulatory authorities.
              Tune in every weekday at 7:00 PM WAT and Saturdays at 8:00 PM WAT for our special draws.
            </Paragraph>
          ...
          <InfoBox>
            <strong>Don't miss our next draw!</strong> Set a reminder to watch our livestreams every weekday at 7:00 PM WAT 
            and Saturdays at 8:00 PM WAT. You might see your number selected as a winner!
          </InfoBox>
        </motion.div>
      </MainContent>
    </PageContainer>
