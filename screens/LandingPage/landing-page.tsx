import { Button, Container, Flex } from "@/components/common/styles";
import {
  HeroSection,
  LandingPageWrapper,
  PrizeCard,
} from "./landing-page.style";
import bgImage from "@/assets/images/landing-page/landing-page-bg.jpg";
import bgPattern from "@/assets/images/landing-page/bg-pattern.png";
